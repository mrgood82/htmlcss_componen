...
if ($s == "edit")
	...
	if ($x2_pengesahan == "true")
		{
		$x2_pengesahan_ket = "<strong>Telah Disahkan oleh Pimpinan.</strong>";
		}
	else
		{
...
if ($_POST['btnSMP'])
	...
	$i_pengesahan = cegah($_POST['pengesahan']);
	...
	if ((empty($no_surat)) OR (empty($asal)))
			...
			if ($tcc != 0)
				...
				mysqli_query($koneksi, "INSERT INTO surat_masuk(kd, no_urut, kd_klasifikasi, kd_sifat, ".
						...
						"'$ruang', '$lemari', '$rak', '$map', '$today')");
                                ...
                                //insert disposisi
				mysqli_query($koneksi, "INSERT INTO surat_masuk_disposisi (kd, kd_indeks, kd_surat, tgl_selesai, ".
				...
				//insert kendali
				mysqli_query($koneksi, "INSERT INTO surat_masuk_kendali (kd, kd_indeks, kd_surat, tgl_selesai, ".
		...
		//jika update
			...
			{
			//query
			mysqli_query($koneksi, "UPDATE surat_masuk SET no_urut = '$no_urut', ".
			...
			if ($tcc != 0)
				{
				//update
				mysqli_query($koneksi, "UPDATE surat_masuk_disposisi SET kd_indeks = '$indeks', ".
						"tgl_selesai = '$tgl_selesai', ".
						"isi = '$i_isi_disposisi', ".
						"diteruskan = '$i_diteruskan', ".
						"pengesahan = '$i_pengesahan', ".
						"kepada = '$i_kepada', ".
				...
				//insert
				mysqli_query($koneksi, "INSERT INTO surat_masuk_disposisi (kd, kd_indeks, kd_surat, tgl_selesai, ".
						"isi, diteruskan, pengesahan, kepada, tgl_kembali) VALUES ".
						"('$x', '$indeks', '$sukd', '$tgl_selesai', ".
						"'$i_isi_disposisi', '$i_diteruskan', '$i_pengesahan', '$i_kepada', '$tgl_kembali')");
				}
			...
			//cek kendali
			$qcc = mysqli_query($koneksi, "SELECT * FROM surat_masuk_kendali ".
						"WHERE kd_surat = '$sukd'");
			$rcc = mysqli_fetch_assoc($qcc);
			$tcc = mysqli_num_rows($qcc);
			...
			if ($tcc != 0)
				{
				//update
				mysqli_query($koneksi, "UPDATE surat_masuk_kendali SET kd_indeks = '$indeks', ".
						"tgl_selesai = '$tgl_selesai', ".
						"kepada = '$i_kepada', ".
						"tgl_kembali = '$tgl_kembali' ".
						"WHERE kd_surat = '$sukd'");
...
if ($_POST['btnHPS'])
	...
	do
		...
		//hapus disposisi
		mysqli_query($koneksi, "DELETE FROM surat_masuk_disposisi ".
				"WHERE kd_surat = '$kd'");
		}
	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".jpg")
			...
			if (!file_exists($path1))
				...
				//query
				mysqli_query($koneksi, "UPDATE surat_masuk SET filex = '$filex_namex' ".
						"WHERE kd = '$kd'");
...
<tr>
<td>
<a href="'.$filenya.'?s=baru" class="btn btn-danger">Input Baru >></a> 
<a href="cari_masuk.php" class="btn btn-danger">Cari Surat Masuk >></a>
</td>
</tr>
</table>';
...
if (($s == "baru") OR ($s == "edit"))
	...
	Status Pengesahan :
	<br>
	<select name="pengesahan">';
	echo '<option value="'.$x2_pengesahan.'" selected>'.$x2_pengesahan_ket.'</option>
	<option value="false">Belum Sah</option>
	<option value="true">Telah Disahkan oleh Pimpinan</option>
	</select>
	...
	<br>
	<input name="btnGNT" type="submit" class="btn btn-danger" value="GANTI IMAGE SURAT >>">';
	}
...
//daftar surat //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($count != 0)
		...
		do
			...
			//indeks berkas
			$qblsx2 = mysqli_query($koneksi, "SELECT surat_m_indeks.*, surat_masuk_disposisi.* ".
