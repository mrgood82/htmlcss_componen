...
(3, 'Jadwal Pertandingan', 'single_menu', 'http://localhost/pssi/jadwal', 4, 0),
(4, 'Berita', 'single_menu', 'http://localhost/pssi/semua_berita', 3, 0),
(5, 'Club', 'single_menu', 'http://localhost/pssi/club', 5, 0),
(11, 'Profile', 'dropdown_menu', '#', 2, 0),
(12, 'Sejarah', 'sub_menu', 'http://localhost/pssi/profile?id_pages=1', 1, 11),
(13, 'Visi Misi', 'sub_menu', 'http://localhost/pssi/profile?id_pages=2', 2, 11),
(14, 'Struktur Organisasi', 'sub_menu', 'http://localhost/pssi/profile?id_pages=3', 3, 11),
(15, 'Login', 'single_menu', 'http://localhost/pssi/login', 6, 0);
