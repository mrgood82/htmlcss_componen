...
<td>:
<input name="no_urut" type="text" value="'.$x_no_urut.'" size="10" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="indeks" type="text" value="'.$blsx_indeks.'" size="10" class="btn btn-default" readonly>
</td>
</tr>
...
echo '<input name="klasifikasi" type="text" value="'.$dtx_klasifikasi.'" size="20" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="tgl_surat" type="text" value="'.$x_surat_tgl.' '.$arrbln1[$x_surat_bln].' '.$x_surat_thn.'" size="20" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="no_surat" type="text" value="'.$x_no_surat.'" size="20" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="asal" type="text" value="'.$x_asal.'" size="30" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="perihal" type="text" value="'.$x_perihal.'" size="30" class="btn btn-default" readonly>
</td>
</tr>
...
<td>:
<input name="tgl_terima" type="text" value="'.$x_terima_tgl.' '.$arrbln1[$x_terima_bln].' '.$x_terima_thn.'" size="30" class="btn btn-default" readonly>
</td>
</tr>
...
<input type="submit" name="btnSMP2" value="SIMPAN" class="btn btn-danger">
<input type="submit" name="btnRST" value="RESET" class="btn btn-warning">

[<a href="masuk_disposisi_pdf.php?sukd='.$sukd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" border="0" width="16" height="16"></a>]

<input type="submit" name="btnDFT" value="DAFTAR SURAT MASUK >>" class="btn btn-success">
<br>
<br>
<br>
</form>';
